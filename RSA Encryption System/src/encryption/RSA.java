...
public class RSA {
	...
	public RSA(String message, String user) {
		...
		try {
			this.publicKey = getPublicKey("C:\\Users\\vidrinen\\git\\Encrypted-Email-Service\\RSA Encryption System\\DataBase\\Users\\" + user + "\\Keys\\" + user + "Public.key");
			this.privateKey = getPrivateKey("C:\\Users\\vidrinen\\git\\Encrypted-Email-Service\\RSA Encryption System\\DataBase\\Users\\" + user + "\\Keys\\" + user + "Private.pub");
